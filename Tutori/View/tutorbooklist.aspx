<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site1.Master" AutoEventWireup="true" CodeBehind="tutorbooklist.aspx.cs" Inherits="Tutori.View.tutorbooklist" %>
         ...
         <div class="col-md-6">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button1" class="btn btn-lg btn-block btn-success" runat="server" Text="Confirm Booking" OnClick="Button1_Click" />
                     </div>
                       <div class="col-6">
                        <asp:Button ID="Button4" class="btn btn-lg btn-block btn-primary" runat="server" Text="Confirm Cancellation" OnClick="Button4_Click" />
                     </div>
                   ...
                   <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Cancel Booking" OnClick="Button2_Click" />
                     </div>
                     <div class="col-6">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-danger" runat="server" Text="Deny Booking" OnClick="Button3_Click" />
                     </div>
                                             ...
                                             <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-12">  
                                                   ...
                                                   Tutori Fee : <b>Rp </b>
                                                   <asp:Label ID="Label11" runat="server" Font-Bold="True"  Text='<%# Eval("tutoriFee") %>'></asp:Label>
                                                </div>
                                             </div>
                                              <div class="row">
                                                <div class="col-12">  
                                                   ...
                                                   Total Fee : <b>Rp </b>
                                                   <asp:Label ID="Label12" runat="server" Font-Bold="True"  Text='<%# Eval("feeReceived") %>'></asp:Label>
                                                </div>
                                             </div>
