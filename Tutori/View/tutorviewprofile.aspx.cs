...
{
    public partial class tutorviewprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update tutor_master_tbl set first_name=@first_name, last_name=@last_name, fullname=@fullname,email=@email,school = @school,subjects=@subjects,biodata=@biodata,state=@state,city=@city,address=@address,password=@password,debit_card=@debit_card,tutoring_fee=@tutoring_fee,dob=@dob WHERE username='" + Session["username"].ToString().Trim() + "'", con);
                ...
                cmd.Parameters.AddWithValue("@subjects", Tsubject.Text.Trim());
                cmd.Parameters.AddWithValue("@biodata", Tbiodata.Text.Trim());
                cmd.Parameters.AddWithValue("@tutoring_fee", TtutoringFee.Text.Trim());
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from tutor_master_tbl where username='" + Session["username"].ToString() + "';", con);
                ...
                Tsubject.Text = dt.Rows[0]["subjects"].ToString();
                Tbiodata.Text = dt.Rows[0]["biodata"].ToString();
                TtutoringFee.Text = dt.Rows[0]["tutoring_fee"].ToString();
